...
sprayFile := Athlete360.files_spray.MSOCgpsNUMfile;

// get the layout (processed layout)
stgLayout := Athlete360.Layouts.MSOCgpsNUM_stg;
...
EXPORT build_MSOCgpsNUM := Athlete360.util.fn_promote_ds(Athlete360.util.constants.stg_prefix,  Athlete360.util.constants.MSOCgpsNUM_name, completestgData);