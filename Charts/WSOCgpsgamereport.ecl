...
filteredGps := Athlete360.files_stg.WSOCgps_stgfile(drillname in ['1st HALF','2ND HALF','1st OT','2ND OT']);
...
completegpsdata := join
    (
        rawDS1,
        Athlete360.files_stg.WSOCgps_stgfile(drillname in ['1st HALF','2ND HALF','1st OT','2ND OT']),
